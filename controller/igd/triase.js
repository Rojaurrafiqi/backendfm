...
export const triase_pemeriksaan_penunjang_pasien_igd = async (req, res) => {
     try {
        const response = await prisma.triase_pemeriksaan_penunjang_pasien_igd.findMany({
            where: {
                id_pasien_igd: Number(req.params.id)
            },
            orderBy: {
...
export const triase_permasalahan_yang_dikonsulkan_pasien_igd = async (req, res) => {
     try {
        const response = await prisma.triase_permasalahan_yang_dikonsulkan_pasien_igd.findMany({
            where: {
                id_pasien_igd: Number(req.params.id)
            },
            orderBy: {
...
export const add_triase_permasalahan_yang_dikonsulkan_pasien_igd = async (req, res) => {

     const {            

            id_pasien_igd,
            permasalahan_yang_dikonsulkan,
      

    } = req.body;
    try {
   
        const rm_Data = await prisma.triase_permasalahan_yang_dikonsulkan_pasien_igd.create({
            data: {
                id_pasien_igd:id_pasien_igd,
...
export const update_triase_permasalahan_yang_dikonsulkan_pasien_igd = async (req, res) => {
 const {         
    ...
    try {
        const data = await prisma.triase_permasalahan_yang_dikonsulkan_pasien_igd.update({
             where: {
                id: Number(req.params.id)
            },
            data: {
